...
const Experience = () => {
  ...
  return (
    <section id="experience" className="py-14 px-4 lg:px-0">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Timeline */}
        <div className="relative border-l border-gray-700 mx-auto max-w-2xl">
          {/* Icon */}
          ...
          {experiences.map((exp, index) => (
            <div key={index} className="ml-6 group relative">
              {/* Card (centered) */}
