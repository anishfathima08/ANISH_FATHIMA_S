...
const Header = () => {
  ...
  return (
    <header className={`fixed top-3 w-full z-[9999] ${navbarOpen ? "pointer-events-auto" : "pointer-events-none"}`}>
      <div className="mx-4 md:mx-8 rounded-full bg-black/30 backdrop-blur-md shadow-lg shadow-white/20 pointer-events-auto">
        <nav className="px-4 flex items-center justify-between h-16">
          {/* Logo */}
          <a href="#home" className="text-3xl font-bold tracking-tight" style={{ fontFamily: "'Dancing Script', cursive" }}>
            Anish&nbsp;&nbsp;Fathima&nbsp;&nbsp;S
          </a>
          ...
          {/* Mobile Hamburger */}
          <button className="lg:hidden text-white pointer-events-auto" onClick={() => setNavbarOpen(!navbarOpen)}>
